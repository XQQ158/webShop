...
.footer-service li a{
	...
	margin: 0 auto;
	background: url(../../assets/img/info.jpg) no-repeat 0px 0px;
}
...
.footer-info .logo{
	width: 55px;
	height: 55px;
	background: #FF6700 url(../../assets/img/mi-logo.png) no-repeat center center;
	position: absolute;
	top:31px;
	left:1px;
}
...
.footer-info .mi{
	height: 20px;
	background: url(../../assets/img/slogan2016.png) no-repeat center center;
	padding-bottom: 30px;
}
